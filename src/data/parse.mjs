...
async function Parse() {
    ...
    const ret = tableData.map(n => {
        ...
        content.push("編號" + index + "=" + n[1].replace(/1/gi,"１").replace(/2/gi,"２") + "," + n[3], n[4], n[5], n[6], n[7], 20, jsonObject[n[0]],
            attri.地 * 10,
            attri.水 * 10,
            attri.火 * 10,
            attri.風 * 10,
...
[452763, "改造水蜘蛛", 3, 28,20,21,24,32, 0.2, 10],
[453055,"優奈",null,15,25,33,19,33,0.2],
[452742,"改造綠色口臭鬼",null,40,25,18,17,25,0.2]
